...
namespace AVL_Tree_Old
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<LeftLeaningRedBlackTree> AVLTrees = new List<LeftLeaningRedBlackTree>();
            List<BinaryTree> binaryTrees = new List<BinaryTree>();


            Parallel.For(0, 1000, i =>
            {
                LeftLeaningRedBlackTree AVLTree = new LeftLeaningRedBlackTree();
            ...
            {
                Console.WriteLine(arrayOperator.IsSorted(AVLTree.InfixTraverse()));
            };
